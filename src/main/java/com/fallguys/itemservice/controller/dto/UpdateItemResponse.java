...
@Schema(description = "부품 기본 정보 수정 응답")
public record UpdateItemResponse(
        ...
        boolean active,
        @Schema(description = "등록일시", example = "2023-04-12T00:00:00")
        String createdAt,
        @Schema(description = "최근 수정일시", example = "2026-06-07T00:00:00")
        String updatedAt
) {

    public static UpdateItemResponse from(ItemView item) {
