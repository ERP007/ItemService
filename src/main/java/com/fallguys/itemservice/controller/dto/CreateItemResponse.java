...
@Schema(description = "부품 신규 등록 응답")
public record CreateItemResponse(
        ...
        boolean active,
        @Schema(description = "등록일시", example = "2026-06-06T10:30:00")
        String createdAt,
        @Schema(description = "최근 수정일시", example = "2026-06-06T10:30:00")
        String updatedAt
) {

    public static CreateItemResponse from(ItemView item) {
