...
@SpringBootTest(properties = {
        "spring.datasource.url=jdbc:h2:mem:openapi_test;MODE=PostgreSQL;INIT=CREATE DOMAIN IF NOT EXISTS JSONB AS JSON;DB_CLOSE_DELAY=-1",
...
class OpenApiDocumentationTest {
    ...
    void exposesPublicItemOpenApiDocumentation() throws Exception {
        mockMvc.perform(get("/items/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/items/batch']").exists())
